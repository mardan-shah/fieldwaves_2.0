      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map(({ label, value, icon: Icon, href, sub }) => (
          <Link key={label} href={href}>
            <SkewContainer variant="glass" className="p-6 border-t-2 border-t-primary h-full" hoverEffect>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <SkewContainer variant="glass" className="p-6">
          ...
          <Link href="/admin/analytics" className="inline-block mt-4">
            <SkewContainer variant="outline" className="px-4 py-2" hoverEffect>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {quickActions.map(({ label, href, icon: Icon }) => (
              <Link key={label} href={href}>
                <SkewContainer variant="ghost" className="p-4 h-full" hoverEffect>
